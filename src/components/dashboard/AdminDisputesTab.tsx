                ...
                <div className="flex flex-wrap gap-4 mt-2 text-sm">
                  ...
                  {dispute.vendor_profile && (
                    <span className="flex items-center gap-1 text-muted-foreground">
                      ...
                      Event Pro: {dispute.vendor_profile.business_name || dispute.vendor_profile.display_name}
                    </span>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <RadioGroup value={selectedOutcome} onValueChange={setSelectedOutcome} className="space-y-2">
                {[
                  ...
                  { value: 'vendor_paid', label: 'Pay Event Pro', desc: 'Release funds to Event Pro' },
