...
import { StickyMiniSearch } from '@/components/book-or-get-booked/StickyMiniSearch';
...
const proFAQs = [
  {
    ...
    a: 'Yes. Verification is optional. Verified Vendors get a badge that helps them stand out.',
  },
  {
              ...
              <div className="relative">
                ...
                <div className="mt-6 flex flex-wrap items-center gap-3">
                  <Button asChild className="rounded-full">
                    <Link to="/become-a-pro">Become an Vendor <ArrowRight className="ml-1.5 w-4 h-4" /></Link>
                  </Button>
